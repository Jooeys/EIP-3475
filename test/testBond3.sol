...
contract ERC3475 is IERC3475 {
    ...
    constructor() {
        ...
        _classes[1]._values["symbol"].stringValue = "Credmei 720D Bond";
        ...
        _classes[1]._values["description"].stringValue = "test/testBond1.sol";
        _classes[1]._values["issuerName"].stringValue = "test/testBond1.sol";
        ...
        _classes[1]._values["issuerURL"].stringValue = "https://credmei.com.br";
      ...
      // define metadata of the class 2";
        _classes[2]._values["symbol"].stringValue = "Credmei 720D BRL Bond";
